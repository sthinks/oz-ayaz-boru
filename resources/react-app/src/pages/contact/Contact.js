...
function Contact() {
  ...
  return !loading ? (
    ...
    <>
      ...
      <ToastContainer />
      <div
        className="mt-24 flex justify-center items-center w-full max-md:mt-6 px-48 max-xl:px-24 relative top-[-700px] mb-[-450px] max-2xl:top-[-40
      ...
      >
        <div className="grid grid-cols-2 max-lg:grid-cols-1 max-lg:gap-10">
          ...
          <div className="w-full h-full flex justify-center items-center shadow-lg bg-white">
            <div className="flex justify-start items-start flex-col max-lg:px-4">
              ...
              <div className="flex justify-center items-start mt-2">
                ...
                <div>
                  ...
                  <p className="my-2 opacity-50 font-normal text-lg">
                    Ferhatpaşa Mah. G24 Sok. No:7834888 Ataşehir / İstanbul
                  </p>
                </div>
              </div>
              <div className="flex justify-center items-start mt-2">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d752.9657277388903!2d29.17757654610691!3d40.98448260804029!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14cacfc521622fbd%3A0x3a745737d0b4a9ee!2sFerhatpasa%20mah!5e0!3m2!1str!2str!4v1680264693882!5m2!1str!2str"
              width="100%"
              height="100%"
              loading="lazy"
